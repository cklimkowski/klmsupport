package klm.pstryk.site.chat;

import klm.pstryk.site.SessionRegistry;
...
public class ChatEndpoint
{
    ...
    {
        private static final String HTTP_SESSION_KEY = "klm.pstryk.ws.http.session";
        private static final String PRINCIPAL_KEY = "klm.pstryk.ws.user.principal";
        private static final String LOCALE_KEY = "klm.pstryk.ws.user.locale";
