...
@EnableJpaRepositories(
        basePackages = "klm.pstryk.site.repositories",
        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    public Jaxb2Marshaller jaxb2Marshaller()
    {
        ...
        marshaller.setPackagesToScan(new String[] { "klm.pstryk.site" });
        return marshaller;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean()
    {
        ...
        factory.setPackagesToScan("klm.pstryk.site.entities",
                "klm.pstryk.site.converters");
