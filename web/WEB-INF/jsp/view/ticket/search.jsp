<%--@elvariable id="searchForm" type="klm.pstryk.site.TicketController.SearchForm"--%>
<%--@elvariable id="searchPerformed" type="boolean"--%>
<%--@elvariable id="results" type="org.springframework.data.domain.Page<klm.pstryk.site.repositories.SearchResult<klm.pstryk.site.entities.Ticket>>"--%>
            ...
            <c:otherwise>
                ...
                <c:forEach items="${results.content}" var="result">
                    ...
                    <a href="<c:url value="/ticket/view/${result.entity.id}" />">
                        <c:out value="${pstryk:abbreviateString(result.entity.subject, 60)}"/>
                    </a><br />
                    ...
                    <pstryk:formatDate value="${result.entity.dateCreated}" type="both"
