...
<%--@elvariable id="ticket" type="klm.pstryk.site.entities.Ticket"--%>
<%--@elvariable id="comments" type="org.springframework.data.domain.Page<klm.pstryk.site.entities.TicketComment>"--%>
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <c:forEach items="${comments.content}" var="comment">
                ...
                (<pstryk:formatDate value="${comment.dateCreated}" type="both"
